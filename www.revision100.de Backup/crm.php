...
<head>
  ...
  <style>
    body { background: #fff !important; background-image: none !important; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif !important; }
    ...
    @media (max-width: 768px) {
      ...
      .crm-toolbar { flex-direction: row !important; flex-wrap: nowrap !important; gap: 6px !important; align-items: stretch !important; }
      .crm-toolbar select { width: calc(25% - 5px) !important; }
      .crm-toolbar button { width: calc(25% - 5px) !important; font-size: 13px !important; padding: 8px 2px !important; }
      .modal-form-row { margin-bottom: 12px; }
      .modal-input { font-size: 16px; }
      .modal-body > div[style*="grid-template-columns"] { display: flex !important; flex-direction: column !important; gap: 12px !important; }
    }
    @media (max-width: 480px) {
      header { padding: 16px 12px 12px 12px !important; margin-bottom: 14px !important; }
      .crm-toolbar { padding: 8px 12px !important; }
...
<div class="crm-layout" style="flex-direction:column;padding:0;">
  <div class="crm-main" style="flex:1;display:flex;flex-direction:column;">
    <div class="crm-toolbar" style="display:flex;gap:12px;align-items:center;padding:12px 16px;border-bottom:1px solid #000;flex-wrap:wrap;">
      ...
      <select id="phaseFilter" onchange="setFilter(this.value)" style="flex:1;min-width:140px;padding:8px 12px;border:1px solid #000;font-family:var(--font-mono);font-size:11px;background:#fff;color:#000;cursor:pointer;">
    ...
    <div id="leadsList" style="flex:1;overflow-y:auto;padding:12px 16px;"></div>
  ...
  <div class="modal">
    ...
    <div class="modal-body">
      ...
      <div class="modal-form-row">
        ...
        <div id="mAddressContainer" style="position:relative;">
          <input class="modal-input" type="text" id="mAddress" placeholder="Straße und Nummer" autocomplete="off">
          <div id="mAddressSuggestions" style="position:absolute;top:100%;left:0;right:0;background:white;border:1px solid #ddd;display:none;z-index:100;max-height:200px;overflow-y:auto;"></div>
        </div>
      </div>
...
function initAddressAutocomplete() {
  ...
  autocomplete.addListener('place_changed', function() {
    ...
    window.mAddressLat = place.geometry.location.lat();
    window.mAddressLon = place.geometry.location.lng();
  });
}
